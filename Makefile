# Makefile for Basal-Ganglia-Segment project
.ONESHELL:
PYTHON_VERSION=3.8
SHELL=/bin/bash
...
ifeq ($(env),venv)
	...
	# Use Conda
	BASE=/opt/conda/envs/basal-ganglia-segment
	NAME=basal-ganglia-segment
	BIN=$(BASE)/bin
...
install:
	...
	@echo '    conda activate basal-ganglia-segment'
setup:
