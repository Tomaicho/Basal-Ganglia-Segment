...
os.system(f'export nnUNet_raw={os.path.join(pwd, "nnunet", "raw")}')
os.system(f'export nnUNet_preprocessed={os.path.join(pwd, "nnunet", "preprocessed")}')
os.system(f'export nnUNet_results={os.path.join(pwd, "nnunet", "models")}')
